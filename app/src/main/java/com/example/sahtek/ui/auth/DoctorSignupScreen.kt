...
fun DoctorSignupScreen(
    ...
    viewModel: DoctorSignupViewModel = viewModel(),
    ...
    SahtekScreenBackground(modifier = modifier) {
        Column(
            ...
            SahtekBrandHeader(
                ...
                subtitle = "Set up your professional workspace to review cases, manage consultations, and follow your schedule."
            )

            SahtekPanel {
                SahtekSectionHeader(
                    title = "Professional profile",
                    subtitle = "Your information helps patients trust your identity and helps the platform organize your workflow."
                )
                ...
                SahtekTextField(
                    ...
                    onValueChange = viewModel::onEstablishmentChange,
            ...
            SahtekPanel {
                SahtekSectionHeader(
                    ...
                    subtitle = "These credentials will be used to access your consultations and schedule."
                )
                    ...
                    onClick = {
                        coroutineScope.launch {
                            ...
                            try {
                                ...
                                Log.e("GoogleSignIn", "Google sign-in failed in DoctorSignupScreen", e)
                                Toast.makeText(
                                    context,
...
@Composable
private fun DoctorSignupScreenPreview() {
    SahtekTheme {
        Surface {
            DoctorSignupScreen()
        }
